...
context "Mixlib::Install::Backend" do
  ...
  context "for chef" do
    ...
    context "for unstable", :unstable do
      ...
      context "when p, pv and m are not present" do
        context "with an integration product version" do
          let(:product_version) { "12.5.1+20151209033604" }
          let(:expected_version) { "12.5.1+20151209033604" }
      ...
      context "when p, pv and m are present" do
        ...
        context "with an integration product version" do
          ...
          let(:expected_info) {
            {
              url: "http://artifactory.chef.co/omnibus-unstable-local/com/getchef/chef/12.5.1+20151209033604/mac_os_x/10.9/chef-12.5.1+20151209033604-1.dmg",
              sha256: "7349f53e4db8b0070ff4dd9700ad73d2552f9f9dae1f2c759574e7543c2d19b3",
              md5: "6d361ac6bb2be408b9e09bdf9609bf13",
              version: "12.5.1+20151209033604"
            }
          }
